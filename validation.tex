...
$XXX<i<XXX$ the simulated galaxy catalog meets the LSST requirements.
For brighter magnitudes the simulated catalogs over-predict the galaxy
counts by upto XXX\%. This discrepancy is to be expected as the volume
sampled by simulated galaxies (covering $4.5^o \times 4.5^o$) is small
relative to the observations and the cosmic variance in the simulated
data will be large. For magnitudes fainter than $i>XXX$ the galaxy
counts fail to meet the number density requirement; deviating by XXX\%
...
The impact at bright magnitudes is negligible - to counts 
...
images of 26.7.  This value is the best reproduces the values presented in
