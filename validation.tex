...
\author{ Simon Krughoff, Andrew Connolly, Yusra AlSayyad, Lynne Jones, Rob Gibson,\\
  Mario Juri{\'c}, {\v Z}eljko Ivezi{\' c}, Debbie Bard, for the LSST Collaboration}
...
%In the case directed toward the galactic bulge all fields
%meet the requirements at the co-added depth except for $b=-10$.  At
%the nominal single epoch depth, the $b=-10$ case fails and the $b=-30$
%case misses the $\pm20\%$ requirement, but makes the $\pm30\%$
%requirement.
...
either model. Toward the bulge the stellar densities disagree by
more than a factor of two at $b=-10$ with Besan\c{c}on predicting a
higher density of stars. This discrepancy is outside of both the
simulation requirements and the margin for the sizing model but is
only for a small part of the survey footprint (for details of this
risk see DMR-21 in the DM Risk Register and the proposed actions in
